...
const handleServiceProviders = async (senderNumber, location, serviceType) => {
    ...
    types: {
      "twilio/carousel": {
        ...
        cards: [
          {
            title: "Plumber 1",
            body: "This is plumber 1",
            media:
              "https://images.stockcake.com/public/1/4/d/14d67abf-b801-4a22-a05c-c3f7b9047732_large/confident-female-plumber-stockcake.jpg",
            actions: [
              {
                type: "QUICK_REPLY",
                title: "Select",
          ...
          {
            title: "Plumber 3",
            body: "This is plumber 3",
            media:
              "https://www.yourfreecareertest.com/wp-content/uploads/2016/07/plumber.jpg",
            actions: [
              {
                type: "QUICK_REPLY",
                title: "Select",
  ...
  axios
    .post("https://content.twilio.com/v1/Content", data, { auth })
    .then((response) => {
      console.log(response.data, ">>>>>>>>>>", response.data.sid);
      const contentSid = response.data.sid;
      return sendMessage({
        to: senderNumber,
        sid: contentSid,
      });
  ...
  //   sid: process.env.TWILIO_CAROUSEL_ID,
  //   // variables: {
  //   //   1: providers[0].name,
  //   //   2: providers[0].key,
  //   //   3: providers[0].price,
